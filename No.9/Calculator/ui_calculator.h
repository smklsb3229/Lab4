...
"}"));
        ...
        Multiply->setDefault(true);
        Button7->setDefault(true);
        Button9->setDefault(true);
        MemAdd->setDefault(true);
        Button6->setDefault(true);
        Button8->setDefault(true);
        Button4->setDefault(true);
        MemClear->setDefault(true);
        Divide->setDefault(true);
        ...
        Add->setDefault(true);
        Subtract->setDefault(true);
        MemGet->setDefault(true);
